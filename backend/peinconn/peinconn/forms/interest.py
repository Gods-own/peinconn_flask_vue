...
class InterestForm(FlaskForm):
    interest = SelectMultipleField( validators=[multipleInputDataRequired()], coerce=int, option_widget=widgets.CheckboxInput(), widget=widgets.ListWidget(prefix_label=False))