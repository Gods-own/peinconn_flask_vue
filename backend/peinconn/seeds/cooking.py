...
class CookingSeeder(Seeder):
    ...
    #activity, interest_id, picture, user_id
        ...
        users = User.query.filter(User.interests.any(Interest.id==8)).all()

        path = 'C:/Users/idumeka oritogun/Documents/flask-projects/Peinconn_Project/backend/peinconn/peinconn/static/cooking'
